...
from aiohttp_gen_api.model.file_extension import FileExtension
from aiohttp_gen_api.model.file_extensions_response import FileExtensionsResponse
from aiohttp_gen_api.model.message_details import MessageDetails
from aiohttp_gen_api.model.message_ids import MessageIds
from aiohttp_gen_api.model.message_ids_from_stream import MessageIdsFromStream
from aiohttp_gen_api.model.message_metadata_response import MessageMetadataResponse
from aiohttp_gen_api.model.message_receipt_detail_response import MessageReceiptDetailResponse
    ...
    def __init__(self, api_client=None):
        ...
        def __delete_allowed_file_extension(
            ...
            **kwargs
            ...
            >>> thread = api.delete_allowed_file_extension(session_token, extension, async_req=True)
            >>> result = thread.get()
        ...
        def __list_allowed_file_extensions(
            ...
            **kwargs
            ...
            >>> thread = api.list_allowed_file_extensions(async_req=True)
            >>> result = thread.get()
        ...
        def __put_allowed_file_extension(
            ...
            **kwargs
            ...
            >>> thread = api.put_allowed_file_extension(session_token, extension, v3_file_extension, async_req=True)
            >>> result = thread.get()
        ...
        def __v1_admin_messages_message_id_metadata_relationships_get(
            ...
            **kwargs
            ...
            >>> thread = api.v1_admin_messages_message_id_metadata_relationships_get(session_token, user_agent, message_id, async_req=True)
            >>> result = thread.get()
        ...
        def __v1_admin_messages_message_id_receipts_get(
            ...
            **kwargs
            ...
            >>> thread = api.v1_admin_messages_message_id_receipts_get(session_token, message_id, async_req=True)
            >>> result = thread.get()
        ...
        def __v1_admin_messages_post(
            ...
            **kwargs
            ...
            >>> thread = api.v1_admin_messages_post(session_token, message_ids, async_req=True)
            >>> result = thread.get()
        ...
        def __v2_admin_streams_stream_id_message_ids_get(
            ...
            **kwargs
            ...
            >>> thread = api.v2_admin_streams_stream_id_message_ids_get(session_token, stream_id, async_req=True)
            >>> result = thread.get()
