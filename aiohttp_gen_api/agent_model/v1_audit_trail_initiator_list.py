...
def lazy_import():
    from aiohttp_gen_api.agent_model.pagination import Pagination
    from aiohttp_gen_api.agent_model.v1_audit_trail_initiator_response import V1AuditTrailInitiatorResponse
