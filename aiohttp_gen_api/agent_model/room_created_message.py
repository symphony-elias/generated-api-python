...
def lazy_import():
    from aiohttp_gen_api.agent_model.room_created_message_all_of import RoomCreatedMessageAllOf
    from aiohttp_gen_api.agent_model.room_tag import RoomTag
    from aiohttp_gen_api.agent_model.v2_base_message import V2BaseMessage
