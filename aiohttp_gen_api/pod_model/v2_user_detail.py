...
def lazy_import():
    from aiohttp_gen_api.pod_model.avatar import Avatar
    from aiohttp_gen_api.pod_model.integer_list import IntegerList
    from aiohttp_gen_api.pod_model.string_list import StringList
    from aiohttp_gen_api.pod_model.user_system_info import UserSystemInfo
