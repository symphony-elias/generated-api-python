...
def lazy_import():
    from aiohttp_gen_api.pod_model.message_download_receipt_count import MessageDownloadReceiptCount
    from aiohttp_gen_api.pod_model.message_receipt_detail import MessageReceiptDetail
    from aiohttp_gen_api.pod_model.message_stream import MessageStream
    from aiohttp_gen_api.pod_model.message_user import MessageUser
    from aiohttp_gen_api.pod_model.pagination import Pagination
