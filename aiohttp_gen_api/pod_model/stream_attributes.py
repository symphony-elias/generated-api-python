...
def lazy_import():
    from aiohttp_gen_api.pod_model.conversation_specific_stream_attributes import ConversationSpecificStreamAttributes
    from aiohttp_gen_api.pod_model.room_specific_stream_attributes import RoomSpecificStreamAttributes
    from aiohttp_gen_api.pod_model.stream_type import StreamType
