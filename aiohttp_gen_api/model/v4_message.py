...
def lazy_import():
    from aiohttp_gen_api.model.v4_attachment_info import V4AttachmentInfo
    from aiohttp_gen_api.model.v4_stream import V4Stream
    from aiohttp_gen_api.model.v4_user import V4User
