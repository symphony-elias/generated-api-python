...
def lazy_import():
    from aiohttp_gen_api.model.v4_connection_accepted import V4ConnectionAccepted
    from aiohttp_gen_api.model.v4_connection_requested import V4ConnectionRequested
    from aiohttp_gen_api.model.v4_instant_message_created import V4InstantMessageCreated
    from aiohttp_gen_api.model.v4_message_sent import V4MessageSent
    from aiohttp_gen_api.model.v4_message_suppressed import V4MessageSuppressed
    from aiohttp_gen_api.model.v4_room_created import V4RoomCreated
    from aiohttp_gen_api.model.v4_room_deactivated import V4RoomDeactivated
    from aiohttp_gen_api.model.v4_room_member_demoted_from_owner import V4RoomMemberDemotedFromOwner
    from aiohttp_gen_api.model.v4_room_member_promoted_to_owner import V4RoomMemberPromotedToOwner
    from aiohttp_gen_api.model.v4_room_reactivated import V4RoomReactivated
    from aiohttp_gen_api.model.v4_room_updated import V4RoomUpdated
    from aiohttp_gen_api.model.v4_shared_post import V4SharedPost
    from aiohttp_gen_api.model.v4_symphony_elements_action import V4SymphonyElementsAction
    from aiohttp_gen_api.model.v4_user_joined_room import V4UserJoinedRoom
    from aiohttp_gen_api.model.v4_user_left_room import V4UserLeftRoom
    from aiohttp_gen_api.model.v4_user_requested_to_join_room import V4UserRequestedToJoinRoom
