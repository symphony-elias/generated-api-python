...
def lazy_import():
    from aiohttp_gen_api.model.room_tag import RoomTag
    from aiohttp_gen_api.model.room_updated_message_all_of import RoomUpdatedMessageAllOf
    from aiohttp_gen_api.model.v2_base_message import V2BaseMessage
