...
def lazy_import():
    from aiohttp_gen_api.model.connection_request_message import ConnectionRequestMessage
    from aiohttp_gen_api.model.room_created_message import RoomCreatedMessage
    from aiohttp_gen_api.model.room_deactivated_message import RoomDeactivatedMessage
    from aiohttp_gen_api.model.room_member_demoted_from_owner_message import RoomMemberDemotedFromOwnerMessage
    from aiohttp_gen_api.model.room_member_promoted_to_owner_message import RoomMemberPromotedToOwnerMessage
    from aiohttp_gen_api.model.room_reactivated_message import RoomReactivatedMessage
    from aiohttp_gen_api.model.room_updated_message import RoomUpdatedMessage
    from aiohttp_gen_api.model.user_joined_room_message import UserJoinedRoomMessage
    from aiohttp_gen_api.model.user_left_room_message import UserLeftRoomMessage
    from aiohttp_gen_api.model.v2_message import V2Message
