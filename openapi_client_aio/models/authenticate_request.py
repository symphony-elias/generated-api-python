...
class AuthenticateRequest(object):
    ...
    def __init__(self, token=None, local_vars_configuration=None):  # noqa: E501
        """AuthenticateRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def token(self):
        ...
        a JWT containing the caller's username or application appGroupId and an expiration date, signed by the caller's private key.  # noqa: E501
