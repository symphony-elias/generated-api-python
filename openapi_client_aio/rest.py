...
from openapi_client_aio.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, \
...
class RESTClientObject(object):
    ...
    def __init__(self, configuration, maxsize=None):
        if maxsize is None:
